...
$insert_pending_order = "insert into pending_orders (customer_id,invoice_no,product_id,product_title,qty,size,order_date,order_status) values ('$customer_id','$invoice_no','$pro_id','$product_title','$pro_qty','$pro_size',NOW(),'$status')";
