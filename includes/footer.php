	...
	<div class="footer-nav">
		<div class="container clearfix">
			...
			<div class="footer-nav__col footer-nav__col--contacts">
				...
				Head Office: Online shop.<br>
          	  Somborski-bulevar, Nis.	
			</address>
				<div class="phone">
					Telephone:
					<a class="phone__number" href="tel:064064064">064064064</a>
				</div>
				<div class="email">
					Email:
					<a href="mailto:nikola@nikola.com" class="email__addr">nikola@nikola.com</a>
				</div>
			</div>
	...
	<div class="page-footer__subline">
		<div class="container clearfix">
			...
			<div class="designby">
				...
				<li> Design updated by Nikola</li>
			</div>
		</div>
	</div>
</footer>
